            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/logo_sman3prabu.png" width="45px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/logo_arrainsyah.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">PERPUSTAKAAN SEKOLAH DASAR ARRAISIYAH
</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/aa2.jpeg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
